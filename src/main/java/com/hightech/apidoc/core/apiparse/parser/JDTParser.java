...
/*
    ...
    private static String getClassName(String fileAbsoLoc) {
        if (fileAbsoLoc.contains("/com/highth")) {
            return fileAbsoLoc.substring(fileAbsoLoc.indexOf("/com/highth") + 1, fileAbsoLoc.lastIndexOf(".")).replace("/", ".");
        } else if (fileAbsoLoc.contains("/com/highth/")) {
            return fileAbsoLoc.substring(fileAbsoLoc.indexOf("/com/highth/") + 1, fileAbsoLoc.lastIndexOf(".")).replace("/", ".");
        } else {
