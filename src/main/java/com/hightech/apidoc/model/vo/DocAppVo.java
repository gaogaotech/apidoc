...
public class DocAppVo {
    ...
    /**  默认版本*/
    private DocAppVersionVo defaultVersionVo;
    /** 总共api个数　**/
    public Integer getTotalApis(){
        Integer totalApis = 0;
        if(this.defaultVersionVo!=null&&!CollectionUtils.isEmpty(defaultVersionVo.getDocServiceVos())){
            for(DocServiceVo serviceVo : defaultVersionVo.getDocServiceVos()){
                if(!CollectionUtils.isEmpty(serviceVo.getDocApiVos())){
                    for(DocApiVo docApiVo : serviceVo.getDocApiVos()){
    ...
    /**  应用消息列表*/
    private List<DocAppMessageVo> docAppMessageVos;

    public List<DocAppMessageVo> getDocAppMessageVos() {
        return docAppMessageVos;
    }

    public void setDocAppMessageVos(List<DocAppMessageVo> docAppMessageVos) {
        this.docAppMessageVos = docAppMessageVos;
    }

    public DocAppVersionVo getDefaultVersionVo() {
        return defaultVersionVo;
    }

    public void setDefaultVersionVo(DocAppVersionVo defaultVersionVo) {
        this.defaultVersionVo = defaultVersionVo;
    }
