...
import com.hightech.apidoc.biz.bean.diff.ApiDiff;
import com.hightech.apidoc.biz.bean.diff.PomDiff;
import com.hightech.apidoc.biz.service.APIComparatorService;
...
import com.hightech.apidoc.model.param.AddFacadeParam;
...
public class ApiController extends BaseController {
    ...
    public Result<DocApiVo> queryInfo(@RequestParam(value = "id") Integer id) {
        ...
        String url = AppConfig.get("superradar_url") + "/chain/online/methodDependencyList";
