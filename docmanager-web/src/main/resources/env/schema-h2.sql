...
CREATE INDEX idx_doc_api ON doc_api(service_id);
...
CREATE UNIQUE INDEX uidx_name ON doc_app(name);
...
CREATE UNIQUE INDEX uidx_app_version ON doc_app_version(app_id,version);
...
CREATE  INDEX idx_doc_service ON doc_service(app_version_id);
