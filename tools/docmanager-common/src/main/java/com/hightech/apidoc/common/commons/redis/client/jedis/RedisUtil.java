 ...
 */
package com.hightech.apidoc.common.commons.redis.client.jedis;
...
import com.hightech.apidoc.common.commons.objects.SerializeUtils;
...
public class RedisUtil {
    ...
    /***
     * 获取到bytes后利用@com.hightech.apidoc.common.commons.objects.SerializeUtils进行反序列化转化为Object对象
     * @param key
     * @return
    ...
    /***
     * 设置指定的在Redis的键的字符串值，并返回其原来的值。中间要将新值和老值用@com.hightech.apidoc.common.commons.objects.SerializeUtils进行转换
     * @param key
     * @param value
     * @return
    ...
    /***
     * 根据key获取列表对象(获取到单个对象的bytes后利用@com.hightech.apidoc.common.commons.objects.SerializeUtils进行反序列化)
     * @param key
     * @return
    ...
    /***
     * 设置key-value对,Object会用@com.hightech.apidoc.common.commons.objects.SerializeUtils进行序列化
     * @param key
     * @param value
     * @return
     * @date: 2016年3月21日 下午2:30:57
    ...
    /***
     * 设置有超期时间（秒）的key-value对,Object会用@com.hightech.apidoc.common.commons.objects.SerializeUtils进行序列化
     * @param key
     * @param value
     * @param seconds
     * @return
    ...
    /***
     * 增加列表中的key-value对,Object会用@com.hightech.apidoc.common.commons.objects.SerializeUtils进行序列化
     * @param key
     * @param value
     * @return
     * @date: 2016年3月21日 下午2:30:57
    ...
    /***
     * 增加列表中的的key-value对,Object会用@com.hightech.apidoc.common.commons.objects.SerializeUtils进行序列化,增加成功后会修改整个list的过期时间
     * @param key
     * @param value
     * @param seconds
     * @return
